...
//            bindingResult.addError(new FieldError("item","price", "가격은 1000원에서 1,000,000 까지 허용합니다."));
//        }
...
//        }
//        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 1000_000) {
//            bindingResult.addError(new FieldError("item", "price",item.getPrice(),false,null,null, "가격은 1000원에서 1,000,000 까지 허용합니다."));
//        }
//        if (item.getQuantity() == null || item.getQuantity() >= 9999) {
